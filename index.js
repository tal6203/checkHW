...
const main = async () => {
  let respons = await fetch('https://www.googleapis.com/books/v1/volumes?q=javascript&maxResults=9&printType=books&orderBy=newest');
...
function create_books(books) {
  ...
  for (let i = 0; i < books.length; i++) {
    ...
    document.getElementById("cards").innerHTML += `<div class = "col"><div class="card" style="width: 18rem ; margin:auto">
        ...
        <div class="card-body">
          ...
          <p class="card-text">By: ${books[i].volumeInfo.authors[0]}</br>
  ...
  document.querySelectorAll(".card").forEach((e) => {
    e.addEventListener("click", (e) => {
      ...
      <input id="first_name" class="form-control" type="text" pattern="^[a-zA-Z]+$"  placeholder="Put your First name here" required/>
      <label for="last_name">Last name:</label>
      <input id="last_name" type="text" class="form-control" pattern="^[a-zA-Z]+$"  placeholder="Put your Last name here"  required/>
      <label for="adress">Adress:</label>
      <input id="adress" type="text" class="form-control"  placeholder="Put your Adress here"  required/>
      <label for="email">Email:</label>
      <input id="email" type="email" class="form-control"  placeholder="Put your Email here"  required/>
      <label for="user_id">ID:</label>
      <input id="user_id" type="text" class="form-control" pattern="[0-9]{9}" maxlength="9" placeholder="Put your ID here"  required/>
